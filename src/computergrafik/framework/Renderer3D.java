...
public class Renderer3D {
     ...
     */
    private final ComputergrafikFrame renderFrame;
     ...
     * Constructor.
     */
    public Renderer3D(Camera c, ComputergrafikFrame renderFrame) {
     ...
     */
    public void onSurfaceCreated(GLAutoDrawable drawable) {
     ...
     */
    public void onSurfaceChanged(GLAutoDrawable drawable, int w, int h) {
        GL2 gl = drawable.getGL().getGL2();
    ...
    public void onDrawFrame(GLAutoDrawable drawable) {
     ...
     */
    private void updateView(GLAutoDrawable drawable) {
        GL2 gl = drawable.getGL().getGL2();
        gl.glLoadIdentity();
